$(document).ready(function() {
	...
	$.getJSON('bikerally_dashboard?riderEventId=' + getParameterByName('ridereventid') + '&crewEventId=' + getParameterByName('creweventid'), function(jsonData) {
		...
		$('#riders2016').html((jsonData.riders2016 ? jsonData.riders2016 + "<span class=\"gray\"> *(*)</span>" : 0));
		$('#riders20161d').html((jsonData.riders20161d ? jsonData.riders20161d + "<span class=\"gray\"> *(*)</span>" : 0));
		$('#crew2016').html((jsonData.crew2016 ? jsonData.crew2016 + "<span class=\"gray\"> *(*)</span>" : 0));
		$('#riders2017').html((jsonData.riders2017 ? jsonData.riders2017 + "<span class=\"gray\"> (" + jsonData.riders2017 + ")</span>" : 0));
		$('#riders20171d').html((jsonData.riders20171d ? jsonData.riders20171d + "<span class=\"gray\"> (" + jsonData.riders20171d + ")</span>" : 0));
		$('#crew2017').html((jsonData.crew2017 ? jsonData.crew2017 + "<span class=\"gray\"> (" + jsonData.crew2017 + ")</span>" : 0));

		Morris.Line({
			element: 'chart',
			data: [
				{ month: '2014-07', 2010:   0, 2011:   4, 2012:   0, 2013:  11, 2014:   1, 2015:   0, 2016:   0, 2017: (jsonData.regAug0 ? jsonData.regAug0 : 0) },
				{ month: '2014-08', 2010:   1, 2011:  26, 2012:  76, 2013:  63, 2014:  45, 2015:  82, 2016:   0, 2017: (jsonData.regSep0 ? jsonData.regSep0 : 0) },
				{ month: '2014-09', 2010:  69, 2011:  43, 2012:  84, 2013: 112, 2014:  68, 2015: 156, 2016:   0, 2017: (jsonData.regOct0 ? jsonData.regOct0 : 0) },
				{ month: '2014-10', 2010:  77, 2011:  65, 2012:  89, 2013: 123, 2014:  75, 2015: 179, 2016:   0, 2017: (jsonData.regNov0 ? jsonData.regNov0 : 0) },
				{ month: '2014-11', 2010:  84, 2011:  83, 2012: 107, 2013: 152, 2014:  93, 2015: 189, 2016:   0, 2017: (jsonData.regDec0 ? jsonData.regDec0 : 0) },
				{ month: '2014-12', 2010: 111, 2011: 108, 2012: 131, 2013: 192, 2014: 119, 2015: 204, 2016:   0, 2017: (jsonData.regJan ? jsonData.regJan : 0) },
				{ month: '2015-01', 2010: 190, 2011: 150, 2012: 238, 2013: 308, 2014: 160, 2015: 242, 2016:   0, 2017: (jsonData.regFeb ? jsonData.regFeb : 0) },
				{ month: '2015-02', 2010: 234, 2011: 255, 2012: 260, 2013: 333, 2014: 202, 2015: 246, 2016:   0, 2017: (jsonData.regMar ? jsonData.regMar : 0) },
				{ month: '2015-03', 2010: 274, 2011: 299, 2012: 284, 2013: 365, 2014: 225, 2015: 256, 2016:   0, 2017: (jsonData.regApr ? jsonData.regApr : 0) },
				{ month: '2015-04', 2010: 298, 2011: 332, 2012: 303, 2013: 383, 2014: 240, 2015: 269, 2016:   0, 2017: (jsonData.regMay ? jsonData.regMay : 0) },
				{ month: '2015-05', 2010: 306, 2011: 347, 2012: 323, 2013: 387, 2014: 248, 2015: 274, 2016:   0, 2017: (jsonData.regJun ? jsonData.regJun : 0) },
				{ month: '2015-06', 2010: 310, 2011: 353, 2012: 328, 2013: 391, 2014: 254, 2015: 276, 2016:   0, 2017: (jsonData.regJul ? jsonData.regJul : 0) },
				{ month: '2015-07', 2010: 315, 2011: 356, 2012: 335, 2013: 392, 2014: 256, 2015: 277, 2016:   0, 2017: (jsonData.regAug ? jsonData.regAug : 0) },
				{ month: '2015-08', 2010: 300, 2011: 298, 2012: 283, 2013: 302, 2014: 184, 2015: 201, 2016:   0, 2017: (jsonData.regSep ? jsonData.regSep : 0) }
			],
			xkey: 'month',
			ykeys: ['2010', '2011', '2012', '2013', '2014', '2015', '2016', '2017'],
			...
			lineColors: ['#BC74C3','#872C91','#9A47A3','#74167E','#cc94d1','#BC74C3','#EA89AB', '#0b62a4'],
			pointSize: 2,
			hideHover: 'auto',
			resize: true,
			behaveLikeLine: true
